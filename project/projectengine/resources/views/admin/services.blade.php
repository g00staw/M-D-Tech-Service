...
<body class="bg-gray">
  ...
  @endif
    ...
    <div class="container justify-content-beetwen">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Usuń usługę</h5>
          <p class="card-text">Kliknij aby przejść do usuwania usług.</p>

          <a href="{{route('admindashboard.remove.service')}}" class="btn btn-primary">Przejdź</a>
    ...
    <div class="container mt-5 d-flex flex-column  border border-radius">
      ...
      @endforeach
          ...
          <div class="mb-3">
            ...
            <input class="form-control" id="cenmin" name="min_price" type="number" step="0.01" required
          ...
          <div class="mb-3">
            ...
            <input class="form-control" id="cenmax" name="max_price" type="number" step="0.01" required
          ...
          <div class="mb-1">
            ...
            <div id="dscHelp" class="form-text">Napisz opis odnośnie usługi. Na czym polega, o ile zostanie odnowiona
              gwarancja itp.</div>
          </div>
