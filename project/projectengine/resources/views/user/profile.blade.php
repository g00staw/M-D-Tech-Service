                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                ...
                                <img src="{{ Auth::user()->profile_photo ? asset('storage/' . Auth::user()->profile_photo) : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}" alt="Zdjęcie profilowe" class="rounded-circle img-fluid" style="width: 150px;">
                                    <h3>Twój awatar</h3>
                                </div>
                        ...
                        <div>
                            <h3>Zmień hasło</h3>
                            <form method="POST" action="{{ route('userdashboard.profile.psschange') }}" class="p-5">
                                @csrf
                        ...
                        <div>
                            <h3>Zmień email</h3>
                            <form method="POST" action="{{ route('userdashboard.profile.emchange') }}" class="p-5">
                                @csrf
                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('userdashboard.profile.phchange') }}" enctype="multipart/form-data">
                                @csrf
